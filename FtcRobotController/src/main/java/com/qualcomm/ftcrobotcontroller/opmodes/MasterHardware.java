 ...
 */
public class MasterHardware extends OpMode

{
...

    {
        ...
        try
        {
            v_motor_left_drive = hardwareMap.dcMotor.get ("motor_2");
        }
        ...
        try
        {
            v_motor_right_drive = hardwareMap.dcMotor.get ("motor_1");
...
REMOVED BY DANALD*/
   ...
   //private DcMotor v_motor_left_arm;
    ...
    int angleToEncoderTicks(int angle){
        int turningCircleDiameter = 15;
        int wheelDiameter = 5;
        double pi = 3.141592653589;
        double inchToCm = 2.54;
        double turnAmount = ((angle/360)*((turningCircleDiameter*pi)/(wheelDiameter*pi*2)))*inchToCm;
